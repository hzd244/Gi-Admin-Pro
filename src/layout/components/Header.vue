  ...
  <a-layout-header>
    ...
    <a-space class="system-head" size="medium">
      ...
      <a-tooltip content="项目配置" position="bl">
        <a-button size="mini" class="gi_hover_btn" @click="SettingDrawerRef?.open" id="header-setting">
          <template #icon>
      ...
      <a-popover position="br" trigger="click">
        <a-badge :count="9" dot id="header-notice">
      ...
      <a-tooltip content="主题切换" position="bottom">
        <GiThemeBtn id="header-theme"></GiThemeBtn>
      </a-tooltip>
